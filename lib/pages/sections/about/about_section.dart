  ...
  Widget description_about() {
    return Column(
      ...
      children: [
        ...
        //   TextSpan(
        //       text: about_me_des6_link,
        //       style: TextStyle(color: linkColor),
        //       recognizer: TapGestureRecognizer()..onTap = launchLaunchedCourse),
        ...
        Text(
          about_me_des7,
          style: TextStyle(fontSize: 16, color: desColor),
        ),
        SizedBox(
          height: 20,
        ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
              child: AutoSizeText(tech,
                  style: TextStyle(color: desColor), maxLines: 2)),
        ],
      ),
    );
  }
    ...
    return Row(
      ...
      children: [
        Text(
          about_index,
          style: TextStyle(
              color: linkColor, fontSize: isMobile(context) ? 18 : 32),
        ),
        AutoSizeText(
          about_me_title,
          style: TextStyle(
              ...
              child: ShaderMask(
                shaderCallback: (mask) {
                  return LinearGradient(colors: [
                    isHovered
                        ? Colors.transparent
                        : hoberImageColor.withOpacity(0.7),
                    isHovered
                        ? Colors.transparent
                        : hoberImageColor.withOpacity(0.7)
